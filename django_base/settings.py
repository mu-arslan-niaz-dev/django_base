...
# See https://docs.djangiproject.com/en/6.0/howto/deployment/checklist/
...
if _db_name:
    ...
    _conn_max_age = os.environ.get("DB_CONN_MAX_AGE", "").strip()
    if _conn_max_age:
        _db["CONN_MAX_AGE"] = int(_conn_max_age)
    _sslmode = os.environ.get("DB_SSLMODE", "").strip()
    if _sslmode:
        _db.setdefault("OPTIONS", {})["sslmode"] = _sslmode
